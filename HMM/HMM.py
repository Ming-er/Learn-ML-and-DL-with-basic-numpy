...
class HMM(object):
	...
	def generate(self,step,latent_variables,observation_variables):
		...
		#主要用到了numpy random模块的多项式取样方法multinomial,思路即简单的隐状态->观测量,隐状态->隐状态的递推
	...
	def _forward(self,obs_seq):
		#前向算法
		#本质上是一种动态规划算法,概率意义上的推导详见《统计学习方法》
	...
	def viterbi(self,obs_seq):
		#解码问题
		#本质上是一种动态规划,很像图论中的最短路径问题,可以类比,注意的地方是记录路径,方便回溯
